 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Jackson Morgan");
		  toPrint += p1.toString("jmorgan45");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Michael Lane");
		  toPrint += p2.toString("mlane35");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Francisco Sanchez");
		  toPrint += p3.toString("fsanchez9");
